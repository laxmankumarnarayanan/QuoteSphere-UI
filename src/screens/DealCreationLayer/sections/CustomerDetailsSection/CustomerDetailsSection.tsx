                        ...
                        return (
                            <div key={index} className="flex flex-col gap-2 mb-6">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-base font-medium text-[#242524]">{contact.customerContactFirstName} {contact.customerContactLastName} {contact.designation && <span className="text-xs text-gray-500 ml-1">({contact.designation})</span>}</span>
                                    {contact.isGuarantor && (

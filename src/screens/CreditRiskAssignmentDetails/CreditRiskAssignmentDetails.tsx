...
const CreditRiskAssignmentDetails: React.FC = () => {
  const { assignmentId } = useParams<{ assignmentId: string }>();
  const navigate = useNavigate();
  const [assignmentDetails, setAssignmentDetails] = useState<CreditRiskAssignmentDetails | null>(null);
  ...
  const fetchAssignmentDetails = async () => {
    try {
      setLoading(true);
      const response = await fetch(`https://dealdesk-web-app-fqfnfrezdefbb0g5.centralindia-01.azurewebsites.net/api/credit-risk-assignments/${assignmentId}`);
      if (response.ok) {
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          >
            ...
            Back to Credit Risk Dashboard
          </button>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Credit Risk Assignment Details</h1>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-medium text-gray-700">Credit Officer ID</span>
              <span className="text-gray-900 flex items-center">
                <User className="w-4 h-4 mr-1" />
                {assignmentDetails.creditOfficerId}
              </span>
            </div>
        ...
        <div className="flex justify-end">
          <button
            onClick={() => alert("The Credit Risk Analysis is submitted. Please update the DealPhase and DealStatus in the Deal table as needed")}
...
export default CreditRiskAssignmentDetails; 